...
Lin et al. \cite{linRealTimeHighResolutionBackground2020a} proposed a method for this task, but it requires an extra background image as input.
...
TODO
Video image matting can be regarded as a binary semantic segmentation task.
